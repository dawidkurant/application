...
namespace Papu.Models
{
    public class CreateThursdayDto
    {
        ...
        //Maksymalna długość łańcucha id czwartkowego śniadania wynosi 3
        [MaxLength(3)]
        public int BreakfastThursdayId { get; set; }

        //Drugie śniadanie wchodzące w skład czwartku
        //Maksymalna długość łańcucha id czwartkowego drugiego śniadania wynosi 3
        [MaxLength(3)]
        public int SecondBreakfastThursdayId { get; set; }

        //Obiad wchodzący w skład czwartku
        //Maksymalna długość łańcucha id czwartkowego obiadu wynosi 3
        [MaxLength(3)]
        public int LunchThursdayId { get; set; }

        //Podwieczorek wchodzący w skład czwartku
        //Maksymalna długość łańcucha id czwartkowego podwieczorku wynosi 3
        [MaxLength(3)]
        public int SnackThursdayId { get; set; }

        //Kolacja wchodząca w skład czwartku
        //Maksymalna długość łańcucha id czwartkowej kolacji wynosi 3
        [MaxLength(3)]
